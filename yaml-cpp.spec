...
Version  : 0.6.3
Release  : 15
URL      : https://github.com/jbeder/yaml-cpp/archive/yaml-cpp-0.6.3/yaml-cpp-0.6.3.tar.gz
Source0  : https://github.com/jbeder/yaml-cpp/archive/yaml-cpp-0.6.3/yaml-cpp-0.6.3.tar.gz
...
%prep
%setup -q -n yaml-cpp-yaml-cpp-0.6.3
cd %{_builddir}/yaml-cpp-yaml-cpp-0.6.3
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579720380
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/yaml-cpp-yaml-cpp-0.6.3/LICENSE %{buildroot}/usr/share/package-licenses/yaml-cpp/c417cfcd91cc771f0113d80b7e106d60c1e3afb7
cp %{_builddir}/yaml-cpp-yaml-cpp-0.6.3/test/gtest-1.8.0/googlemock/LICENSE %{buildroot}/usr/share/package-licenses/yaml-cpp/5a2314153eadadc69258a9429104cd11804ea304
cp %{_builddir}/yaml-cpp-yaml-cpp-0.6.3/test/gtest-1.8.0/googlemock/scripts/generator/LICENSE %{buildroot}/usr/share/package-licenses/yaml-cpp/1d4719e04eaa4909ab5a59ef5cb04d2a5517716e
cp %{_builddir}/yaml-cpp-yaml-cpp-0.6.3/test/gtest-1.8.0/googletest/LICENSE %{buildroot}/usr/share/package-licenses/yaml-cpp/5a2314153eadadc69258a9429104cd11804ea304
pushd clr-build
%make_install
popd
